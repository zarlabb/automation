...
public class taskSixCars {
	...
	public static void main(String[] args) {
		...
		System.out.println("BMW:" +TotalFuel("BMW"));
		System.out.println("Audi:" +TotalFuel("Audi"));
		System.out.println("Porsche:" +TotalFuel("Porsche"));
		System.out.println("Honda:" +TotalFuel("Honda"));
	}
